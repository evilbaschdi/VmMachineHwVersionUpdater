            ...
            var list = new List<KeyValuePair<string, string>>
                       {
                           ...
                           new KeyValuePair<string, string>("debian8", "Debian 8"),
                           new KeyValuePair<string, string>("debian8-64", "Debian 8 x64"),
                           //Mac
                           new KeyValuePair<string, string>("darwin", "Mac OS X 10.5"),
                           new KeyValuePair<string, string>("darwin-64", "Mac OS X 10.5 x64"),
                           new KeyValuePair<string, string>("darwin10", "Mac OS X 10.6"),
                           new KeyValuePair<string, string>("darwin10-64", "Mac OS X 10.6 x64"),
                           new KeyValuePair<string, string>("darwin11", "Mac OS X 10.7"),
                           new KeyValuePair<string, string>("darwin11-64", "Mac OS X 10.7 x64"),
                           new KeyValuePair<string, string>("darwin12", "Mac OS X 10.8"),
                           new KeyValuePair<string, string>("darwin12-64", "Mac OS X 10.8 x64"),
                           new KeyValuePair<string, string>("darwin13", "Mac OS X 10.9"),
                           new KeyValuePair<string, string>("darwin13-64", "Mac OS X 10.9 x64"),
                           new KeyValuePair<string, string>("darwin14", "Mac OS X 10.10"),
                           new KeyValuePair<string, string>("darwin14-64", "Mac OS X 10.10 x64"),
                           new KeyValuePair<string, string>("darwin15", "Mac OS X 10.11"),
                           new KeyValuePair<string, string>("darwin15-64", "Mac OS X 10.11 x64"),
                           //Other.
